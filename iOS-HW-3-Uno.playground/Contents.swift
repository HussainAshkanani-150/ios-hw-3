...
for c in color {
    for number in 0...9 {
        cards.append(Card(color: c, number: number))
    }
    for number in 1...9 {
        cards.append(Card(color: c, number: number))
    }
    for action in actions {
        cards.append(Card(color: c,actions: action))
    }
    for blackAction in blackActions {
        cards.append(Card(color: c, blackActions: blackAction))
    }
}
